...
package com.nakhl.shiraznovin.widget;
...
import com.nakhl.shiraznovin.utils.ThrottledContentObserver;
...
public class TickerWidgetService extends Service {
    ...
    private void updateWidgets() {
        ...
        Cursor unread = getContentResolver().query(EntryColumns.CONTENT_URI, new String[]{FeedData.ALL_UNREAD_NUMBER}, null, null, null);
        if (unread != null) {
